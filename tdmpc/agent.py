...
https://github.com/nicklashansen/tdmpc (src/algorithm/tdmpc.py::TDMPC)

Implements Algorithm 1 (MPPI planning, in plan()/estimate_value()) and
Algorithm 2 (joint TD-learning, in update()/update_pi()/_td_target()) from
"Temporal Difference Learning for Model Predictive Control" (arXiv:2203.04955).
"""
import numpy as np
import torch
